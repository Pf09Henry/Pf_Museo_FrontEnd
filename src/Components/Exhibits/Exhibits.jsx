        ...
        <div>
            ...
            <div class="card mb-3" >
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">Paleontologia</h5>
                            ...
                            <div>
                                <Link to='/details'>
                                    <button type="button" class="btn btn-outline-success btn-secundario">Info</button>
                                </Link>
                            </div>
                        </div>
                    </div>
