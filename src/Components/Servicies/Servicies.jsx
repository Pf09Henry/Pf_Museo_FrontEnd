...
<div className='d-grid row position-relative overflow-hidden p-2 p-lg-4 m-md-2 text-center ' >
  ...
  <div className="col">
    ...
    <div className="text-bg-light me-md-3 pt-2 px-3 pt-md-4 px-md-4 text-center overflow-hidden">
        ...
        <ul class="list-group">
          ...
          <li className='list-group-item'><MdOutlineRememberMe size={25}/> Membresía</li>
          <li className='list-group-item'><MdCastForEducation size={25}/> Actividades Educativas</li>
          <li className='list-group-item'><MdTour size={25}/> Informes Turísticos	</li>
        </ul>
        </div>
      </div>
  ...
  <div className="col">
    <div className="text-bg-light me-md-3 pt-2 px-2 pt-md-4 px-md-4 text-center overflow-hidden rounded">
      <div className="my-2 py-2 fs-4">
      <ul class="list-group ">
        <li className='list-group-item list-group-item-dark'><MdOutlineLocalGroceryStore size={25}/> Tienda</li>
        <li className='list-group-item list-group-item-dark'><GiClothes size={25}/> Guardarropa</li>
        ...
        <li className='list-group-item list-group-item-dark'><BiAccessibility size={25}/> Rampas de Acceso</li>
        ...
        <li className='list-group-item list-group-item-dark'><GiWalkingBoot size={25}/> Caminatas de Interpretación de la Naturaleza</li> 
      </ul>
      </div>
    </div>
  </div>
